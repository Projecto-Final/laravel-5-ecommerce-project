...
Route::group(['middleware' => 'App\Http\Middleware\AdminMiddleware'], function()
{
	...
	*/
	...
	Route::get('administracion/facturas/xml/{idFactura}', 'LogedAdminMethods@generar_factura_xml');
	Route::get('administracion/facturas/pdf/{idFactura}', 'LogedAdminMethods@generar_factura_pdf');
	...
	Route::get('administracion/subcategorias/crear', 'LogedAdminMethods@crear_subcategoria');
	Route::put('administracion/subcategorias/crear', 'LogedAdminMethods@guardar_nueva_subcategoria');
...
Route::get('get_chats_recibidos', 'LogedUserMethods@get_chats_redibidos'); 
