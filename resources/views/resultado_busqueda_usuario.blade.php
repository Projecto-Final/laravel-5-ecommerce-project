                        ...
                        <div class="item-inner clearfix">
                          ...
                          <div class="item-info">
                            <div class="info-inner">
                              <div class="item-title"> <a href="" onclick="javascript: return true" title=" Retis lapen casen ">{{ $usuario['username'] }} </a> </div>
                              <div class="item-content clearfix">
                              </div>
                              <a href="{{ url('perfil/'.$usuario['id']) }}"><button title="Add to Cart" class="btn-cart" onclick="">Ver</button></a>
                            </div>
                          </div>
                        </div>
                      </div>
